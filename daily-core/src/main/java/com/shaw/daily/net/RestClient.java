...
import com.shaw.daily.net.callback.RequestCallbacks;
import com.shaw.daily.net.download.DownloadHandler;
import com.shaw.daily.ui.loader.DailyLoader;
...
public class RestClient {
    ...
    private void request(HttpMethod method){
        ...
        if(LOADER_STYLE != null){
            DailyLoader.showLoading(CONTEXT,LOADER_STYLE);
        }
